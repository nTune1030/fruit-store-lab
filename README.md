...
DATA SOURCE                        SCRIPTS (YOUR LOGIC)                       DESTINATIONS
===========                        ====================                       ============

[ ~/supplier-data/ ]
      |
      | (Images)
      +--- .TIFF Files  -------->  [ changeImage.py ]
                                          |
                                          v
                                     .JPEG Files
                                          |
                                          v
                                   [ supplier_image_upload.py ]  ---------->  [ Web Server ]
                                                                              (POST /upload/)

      | (Text)
      +--- .txt Files   -------->  [ run.py ]  ---------------------------->  [ Web Server ]
            |                                                                 (POST /fruits/)
            |
            |
            +------------------->  [ report_email.py ]
                                          |
                                          +--- (imports reports.py) ------->  [ /tmp/processed.pdf ]
                                          |                                            |
                                          +--- (imports emails.py)   ------------------+
                                                                                       |
                                                                                       v
